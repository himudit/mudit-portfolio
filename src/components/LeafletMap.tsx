    ...
    return (
        <div className="relative p-4 sm:p-6 md:p-8 bg-white dark:bg-black py-16">
            ...
            <div className="max-w-full mx-auto px-5 relative z-10">
                <div
                    className="w-full bg-bg border-4 border-black dark:bg-darkBg shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transform hover:-translate-y-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all duration-300 p-6 mb-10"
                >
